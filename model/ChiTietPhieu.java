...
public class ChiTietPhieu {
    ...
    public ChiTietPhieu(String maPhieu, String maSH, int soLuong, double donGia) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(this.maSH, other.maSH);
    }

    @Override
    public String toString() {
        return "ChiTietPhieu{" + "maPhieu=" + maPhieu + ", maSH=" + maSH + ", soLuong=" + soLuong + ", donGia=" + donGia + '}';
    }
