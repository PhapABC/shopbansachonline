...
public class WritePDF {
    ...
    public void writePhieuNhap(String mapn) {
        ...
        try {
            ...
            for (ChiTietPhieu ctpn : ChiTietPhieuNhapDAO.getInstance().selectAll(mapn)) {
                Sach mt = SachDAO.getInstance().selectById(ctpn.getMaSH());
                pdfTable.addCell(new PdfPCell(new Phrase(ctpn.getMaSH(), fontData)));
                pdfTable.addCell(new PdfPCell(new Phrase(mt.getTenSH(), fontData)));
    ...
    public void writePhieuXuat(String mapn) {
        ...
        try {
            ...
            Paragraph para4 = new Paragraph(new Phrase("Khách hàng: " +KhachHangDAO.getInstance().selectById(pn.getMakh()).getTenkh(), fontData));
            para1.setIndentationLeft(40);
            para2.setIndentationLeft(40);
