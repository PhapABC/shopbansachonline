...
public class UpdatePhieuXuat extends javax.swing.JDialog {
    ...
    private void displayInfo() {
        ...
        cboMakh.setSelectedItem(phieuxuat.getMakh());
    }
    ...
    private void initComponents() {
        ...
        txtNguoiTao1.setFont(new java.awt.Font("SF Pro Display", 0, 15)); // NOI18N
        jPanel2.add(txtNguoiTao1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 80, 390, 36));
        ...
        jPanel2.add(txtTenkh, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 180, 390, 36));
        ...
        jPanel2.add(cboMakh, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 132, 390, 40));
            ...
            if (soluongselect == 0) {
                ...
                if (soluongselect < soluong) {
                    ...
                    if (mtl != null) {
                        ...
                        ChiTietPhieu ctp = new ChiTietPhieu(phieuxuat.getMaPhieu(), mt.getMaSH(), soluong, mt.getGia());
                        CTPhieu.add(ctp);
                    }
                    loadDataToTableNhapHang();
    ...
    private void btnNhapHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhapHangActionPerformed
        ...
        if (CTPhieu.isEmpty()) {
            ...
            for (var ct : CTPhieuOld) {
                SachDAO.getInstance().updateSoLuong(ct.getMaSH(), SachDAO.getInstance().selectById(ct.getMaSH()).getSoLuong() + ct.getSoLuong());
            ...
            PhieuXuat pn = new PhieuXuat(cboMakh.getSelectedItem().toString(),phieuxuat.getMaPhieu(), sqlTimestamp, txtNguoiTao.getText(), CTPhieu, tinhTongTien());
            try {
