...
//            ArrayList<Sach> armt = mtdao.selectAllE();
...
//            }
    ...
    private void initComponents() {
        ...
        jComboBoxLuaChon.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Mã sách", "Tên sách", "Số lượng", "Đơn giá", "Tác giả", "NXB", "Mô tả", "Đã xóa", " " }));
    ...
    public void xoaSachSelect() {
        ...
        if (luaChon == JOptionPane.YES_OPTION) {
            SachDAO.getInstance().delete(getSachSelect());
    ...
    public Sach getSachSelect() {
        int i_row = tblSanPham.getSelectedRow();
        Sach acc = SachDAO.getInstance().selectAll().get(i_row);
        return acc;
    }
        ...
        try {
            ...
            for (Sach i : result) {
                if (i.getTrangThai() == 1) {
                    ...
                    tblModel.addRow(new Object[]{
                        i.getMaSH(), i.getTenSH(), i.getSoLuong(), formatter.format(i.getGia()) + "đ", i.getTacGia(), i.getNhaXB(), i.getNgayPH(), loaisach
                    });
                }
            }
        } catch (Exception e) {
