...
public class ThongKeForm extends javax.swing.JInternalFrame {
    ...
    public ThongKeForm() {
        ...
        txtQuantityProduct.setText(Integer.toString(SachDAO.getInstance().getSl()));
    ...
    private void initComponents() {
        ...
        tblThongKeProduct.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã sách", "Tên sách", "Số lượng nhập", "Số lượng xuất"
            }
        ));
        ...
        tblKhachHang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã khách hàng", "Tên khách hàng", "Địa chỉ", "Số điện thoại", "Số hóa đơn đã mua"
            }
        ));
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel14Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jToolBar2, javax.swing.GroupLayout.PREFERRED_SIZE, 386, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void loadDataToTableKh(ArrayList<KhachHang> kh) {
        try {
            DefaultTableModel tblTableKH = (DefaultTableModel) tblKhachHang.getModel();
            tblTableKH.setRowCount(0);
            for (KhachHang i : kh) {
                tblTableKH.addRow(new Object[]{
                    i.getMakh(), i.getTenkh(), i.getDc(), i.getSdt()
                });
            }
        } catch (Exception e) {
        }
    ...
    private void loadDataToTableThongKeProduct(ArrayList<ThongKeProduct> thongKe) {
        try {
            ...
            for (int i = 0; i < thongKe.size(); i++) {
                tblModelAcc.addRow(new Object[]{
                    (i + 1), thongKe.get(i).getMaSH(), thongKe.get(i).getTenSH(), thongKe.get(i).getSlNhap(), thongKe.get(i).getSlXuat()
                });
            }
    ...
    private ArrayList<ThongKeProduct> searchTenSanPhamThongKe(ArrayList<ThongKeProduct> arr, String name) {
        ...
        for (ThongKeProduct i : arr) {
            if (i.getMaSH().toLowerCase().contains(name.toLowerCase()) || i.getTenSH().toLowerCase().contains(name.toLowerCase())) {
                result.add(i);
            }
        }
        return result;
